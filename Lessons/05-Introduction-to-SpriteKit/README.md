...
1. **1 minute** Think about one thing that's not 100% clear to you, regarding any of these topics.
2. **5 minute** Get in groups of 2 or 3 and share your doubts, see if you can get them answered by your classmates.
3. **1 minute** Only if no one in the group can answer a doubt, write it down. And give it to the instructor.
